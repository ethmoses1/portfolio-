(function($){
    ...
    $('#project-3-modal').on('shown.bs.modal', function () {
      $( '#project-3-slide' ).resize();
    });

    $('#project-2-slide').flexslider({
        animation: "slide",
        directionNav: true,
        touch: true,
        slideshow: false,
    ...
    $('#project-2-modal').on('shown.bs.modal', function () {
      $( '#project-2-slide' ).resize();
    });

    $('#project-1-slide').flexslider({
        animation: "slide",
        directionNav: true,
        touch: true,
        slideshow: false,
    ...
    $('#project-1-modal').on('shown.bs.modal', function () {
      $( '#project-1-slide' ).resize();
    });

    $('#project-0-slide').flexslider({
        animation: "slide",
        directionNav: true,
        touch: true,
        slideshow: false,
    ...
    $('#project-0-modal').on('shown.bs.modal', function () {
      $( '#project-0-slide' ).resize();
    });
...
function scrollFunction() {
  if (document.body.scrollTop > 50 || document.documentElement.scrollTop > 50) {
    document.getElementById("theme-options-wrapper").style.marginTop = "20px";
  } else {
    document.getElementById("theme-options-wrapper").style.fontSize = "28.8px";
  }
}
